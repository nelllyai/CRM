...
const createRow = product => {
  ...
  if (hasImage) tr.dataset.pic = image;
  ...
  const imageIcon = hasImage ?
    `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M17.7778 2.22223H2.22223C1.92754 2.22223 1.64493 2.33929
          ...
          fill="#6E6893"/>
        <path
          d="M12.6555 8.53889L9.65555 11.5389L7.43332 9.31666C7.32923
    ...
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      17.5H16.25C16.5814 17.4995 16.899 17.3676 17.1333 17.1333C17.3676 16.899
      17.4995 16.5814 17.5 16.25V3.38375L18.75 2.13375ZM16.25
      ...
      10.9888C14.3993 10.7544 14.0815 10.6228 13.75 10.6228C13.4185 10.6228
      13.1007 10.7544 12.8663 10.9888L11.875 11.98L10.3894 10.4944L16.25
      4.63375V12.605Z" fill="#6E6893"/>
  ...
  tr.insertAdjacentHTML(
      ...
      <td class="cms__td cms__td_small-padding">
        <button class="table-button table-button_image"
          ${hasImage ? '' : 'disabled style="cursor: not-allowed;"'}>
          ${imageIcon}
        </button>
      </td>
      <td class="cms__td cms__td_small-padding">
        <button class="table-button table-button_edit">
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_2015_14)">
              <path
                d="M15.5629 4.86078L17.6394 6.93629L15.5629 4.86078ZM16.8982
                ...
                2.8636 16.8982 3.03233V3.03233Z"
                stroke="#6E6893" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round" />
              <path
                d="M18.0394 14.2648V17.206C18.0394 17.726 17.8328 18.2248
      ...
      <td class="cms__td cms__td_small-padding">
        <button class="table-button table-button_delete">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M5.03125 1.59375H4.875C4.96094 1.59375 5.03125 1.52344
              5.03125 1.4375V1.59375H10.9688V1.4375C10.9688 1.52344 11.0391
              1.59375 11.125 1.59375H10.9688V3H12.375V1.4375C12.375 0.748047
              11.8145 0.1875 11.125 0.1875H4.875C4.18555 0.1875 3.625
              0.748047 3.625 1.4375V3H5.03125V1.59375ZM14.875
              3H1.125C0.779297 3 0.5 3.2793 0.5 3.625V4.25C0.5 4.33594
              0.570312 4.40625 0.65625 4.40625H1.83594L2.31836
              14.6211C2.34961 15.2871 2.90039 15.8125 3.56641
              15.8125H12.4336C13.1016 15.8125 13.6504 15.2891 13.6816
